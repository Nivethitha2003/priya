...
class ViewData:
    def __init__(self):
        def dataupload():
            s1 = "D:\Fake_Signature_verification\Dataset\Train"
            messagebox.showinfo("Success", s1)

        def viewdata():
            workingDir = ".\Desktop\nivi\Fake_Signature_verification\Dataset"
            PATH = os.path.sep.join([workingDir, "Train"])
            train_dir = os.path.join(".\Desktop\nivi\Fake_Signature_verification\Dataset", "Train")

            # Getting the path to the validation directory
            validation_dir = os.path.join(".\Desktop\nivi\Fake_Signature_verification\Dataset", "Train")

            fake_train_dir = os.path.join(train_dir, "forged")
            original_train_dir = os.path.join(train_dir, "genuine")
            ...
            fake_val_dir = os.path.join(validation_dir, "forged")
            original_val_dir = os.path.join(validation_dir, "genuine")
        ...
        def viewdata1():
            ...
            validation_dir = os.path.join("D:\Fake_Signature_verification\Dataset", "Train")
            train_dir = os.path.join("D:\Fake_Signature_verification\Dataset", "Train")
            batch_size = 2000
            epochs = 20
            IMG_HEIGHT = 98
            IMG_WIDTH = 98
        ...
        win = Tk()
        win.title("Fake Signature Verification")
        ...
        Label(win, text='Fake Signature Verification', bg="#34bfbb", font='verdana 15 bold') \
            .place(x=220, y=120)
